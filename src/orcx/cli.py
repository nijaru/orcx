...
def models() -> None:
    ...
    typer.echo()
    typer.echo("Examples:")
    typer.echo("  openrouter/deepseek/deepseek-v3.2")
    typer.echo("  openrouter/anthropic/claude-4.5-sonnet")
    typer.echo("  openrouter/openai/gpt-5.2")
    typer.echo("  openrouter/google/gemini-3-flash-preview")
    typer.echo()
